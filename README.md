My Burger is an app that allows you create a burger and place an order for the burger you created. The front-end was made with React and I got to use Redux for easier state and data management.
